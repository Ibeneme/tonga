...
export const FAQ_ITEMS = [
    {
        ...
        answer: 'A valid overseas driving licence is sufficient. A Tongan driving licence must include category A (motorcycles), even though our scooters are only 49cc.',
    },
    {
    ...
    },
    {
        ...
        answer: 'The fuel level is recorded at pickup, and scooters must be returned with the same fuel level. A full tank costs approximately 10 Paanga. Only unleaded petrol should be used.',
    },
    {
