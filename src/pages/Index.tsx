    ...
    <Layout>
      ...
      <section className="py-16 md:py-24 bg-sand overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto" staggerDelay={0.25}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal direction="up">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <StaggerContainer className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6" staggerDelay={0.2}>
                {[
                  { value: '50 TOP', label: 'Solo Scooter / Day', icon: '🛵' },
                  { value: '70 TOP', label: '2-Rider Scooter / Day', icon: '👫' },
                  ...
                  <StaggerItem key={index}>
                    ...
                    >
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-br from-primary-foreground/0 to-primary-foreground/10 opacity-0 group-hover:opacity-100 transition-opacity"
                      />
                      <motion.div
                      ...
                      <p className="text-primary-foreground/80 text-sm md:text-base relative z-10">{item.label}</p>
                    </motion.div>
                  </StaggerItem>
                ))}
              </StaggerContainer>
      ...
      <section className="py-16 md:py-24 bg-sand overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto" staggerDelay={0.25}>
                      ...
                      <div className="flex gap-1 mb-4">
                        {[...Array(5)].map((_, i) => (
                          <motion.div
                            ...
                            transition={{ delay: 0.08 * i + index * 0.1, duration: 0.4, type: 'spring' }}
                            viewport={{ once: true }}
