    ...
    <footer className="bg-foreground text-primary-foreground mt-auto">
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-sm sm:text-base">SCOOTER RENTAL TONGA</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2 text-primary-foreground/70">
                ...
                <a href={`tel:${BUSINESS_CONFIG.phone.replace(/\s/g, '')}`} className="hover:text-primary-foreground transition-colors">
                  {BUSINESS_CONFIG.phone}
                </a>
              </li>
              <li className="flex items-center gap-2 text-primary-foreground/70">
                <Mail className="w-4 h-4 flex-shrink-0" />
                <a href={`mailto:${BUSINESS_CONFIG.email}`} className="hover:text-primary-foreground transition-colors">
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center text-sm text-primary-foreground/50">
          ...
          <p className="mt-1">Payment accepted: PayPal (USD)</p>
        </div>
      </div>
    </footer>
  );
